	...
	<?php include('nav.php') ?>
   	...
   	<div id="pt-main" class="pt-perspective">
		<div class="content pt-page pt-page-1">
			...
			<header class="content-upper">
				
				<div class="video-holder">
					<div class="video">
						<p class="standin-text">VIDEO</p>
						<a class="fa fa-expand video-ex"></a>
						<div class="text-overlay">
							<img class="logo" src="img/zd-logo.svg" alt="Zen Den Web Design">
			...
			<button class="fa fa-angle-down trigger"><span>Trigger</span></button>
			<div class="title">
		...
		<script src="_/js/05_articleIntroEffects.js"></script>
		<script>
